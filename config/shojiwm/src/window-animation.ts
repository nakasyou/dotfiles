import { read, type EasingFunction, type WaylandWindow, type WindowStateKey } from 'shoji_wm'
...
const activeRectAnimationTargetByWindow = new WeakMap<
  WaylandWindow,
  Map<symbol, RectAnimationTarget>
>()
...
function activeRectTarget(
  window: WaylandWindow,
  windowRectState: WindowStateKey<ManagedWindowRect>,
): RectAnimationTarget | undefined {
