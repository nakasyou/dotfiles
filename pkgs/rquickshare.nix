...
rustPlatform.buildRustPackage rec {
  ...
  patches = [
    ./rquickshare-fix-pnpm-outdated-lockfile.patch
    ./rquickshare-tauri-2.2.patch
  ];
  ...
  pnpmDeps = fetchPnpmDeps {
    ...
    fetcherVersion = 1;
    hash = "sha256-tL/VXbBObOhQuILezqWm2b0cXBSUlDWUCj+VeHyISus=";
  };

  cargoRoot = "app/main/src-tauri";
  buildAndTestSubdir = cargoRoot;
  cargoPatches = [
    ./rquickshare-remove-duplicate-versions-of-sys-metrics.patch
    ./rquickshare-remove-code-signing-darwin.patch
  ];
